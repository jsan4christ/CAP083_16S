...
a) To identify community state types (CSTs) based on the composition and relative abundance of bacterial species
b) To assess whether the treatment caused individual participant transitions between CSTs, particularly towards Lactobacillus dominated CSTs
c) Compare genital cytokine concentrations with prevalent CSTs
